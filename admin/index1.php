...
//sum of extended  payment
$sql15 = "SELECT SUM(extend_amount) AS total_amount FROM extendpayment";
$data15 = select_data($sql15);
$totalAmount1 = mysqli_fetch_assoc($data15)['total_amount'];
...
$sql16="SELECT * FROM extendbooking where status='1'";
$data16=select_data($sql16);
$count16=mysqli_num_rows($data16);

//count of products
$sql11="SELECT * FROM product";
$data11=select_data($sql11);
$count11=mysqli_num_rows($data11);

//count of products
$sql12="SELECT * FROM booking where scooter_category='top'";
$data12=select_data($sql12);
$count12=mysqli_num_rows($data12);


//count of products
$sql13="SELECT * FROM booking where scooter_category='normal'";
$data13=select_data($sql13);
$count13=mysqli_num_rows($data13);

//count of extendbookingbookings
$sql14="SELECT * FROM extendbooking";
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total Scooters</h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Normal Bookings</h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Extended Bookings</h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total Extended Amount</h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Extended Current Bookings</h5>
