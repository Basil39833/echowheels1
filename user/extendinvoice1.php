...
$id = $_GET['id'];
$sql1="select * from extendbooking where booking_id='$id'" ;
...
<br>
This is a receipt for extend your booking <strong>[SCOOTERNAME]</strong> from our website Echo Wheels
</div>
...
<strong>[BOOKINGDATE&TIME]</strong>
</div>
</div>
</div>
...
<strong>[PICKUPSTATION]</strong>

</div>
<div class="col-sm-6 text-right">
<span>Drop Station</span>
<strong>[DROPSTATION]</strong>
</div>
</div>
</div>
<div class="payment-details">
...
<div class="footer">
© Copyright Echo Wheels. All Rights Reserved
</div>
</div>
</div>
</div>
