...
$id = $_GET['id'];
$sql1="select * from extendbooking where extend_id='$id'" ;
      ...
      <div class="invoice">
         ...
         <div class="invoice-company">
            ...
            <button type="button" class="btn btn-dark" onclick="window.print();"><i class="fa fa-print"></i>
                Print As Pdf</button>
                <div class="btn-group">
                      <a href="extendpdf1.php?id=<?php echo $arr1['booking_id'] ?>" class="btn btn-danger btn">Send Receipt Email</a>
         ...
         <div class="invoice-header">
            <div class="invoice-from">
               ...
               <address class="m-t-5 m-b-5">
                  <strong class="text-inverse">Echo Wheels</strong><br>
                  Edapally,<br>
                  Cochin, Kerala<br>
                  Phone: 6238813582<br>
                  Mail: echowheels7@gmail.com
               </address>
            </div>
            ...
            <div class="invoice-date">
               <h4>SCOOTER ID - <?php echo $arr1['booking_id'];?></h4>
         ...
         <div class="invoice-content">
               ...
               <table class="table table-invoice">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td><?php echo $arr1['scooter_name'];?></td>
                        <td><?php echo $arr1['extend_total'];?></td>
                        <td><?php echo $arr1['pickup_station'];?></td>
                        <td><?php echo $arr1['drop_station'];?></td>
                        <td><?php echo $arr1['booking_date'];?></td>
                        <td><?php echo (int) $arr1['extend_rent_hour'];?></td>
                     </tr>
                     <!--<tr>
                        <td>
            ...
            <div class="invoice-price">
               ...
               <div class="invoice-price-right">
                  <b><medium>TOTAL : </medium> <span class="f-w-600"><?php echo $arr1['extend_total'];?></span></b>
               </div>
            </div>
            <!-- end invoice-price -->
         </div>
         ...
         <div class="invoice-footer"><h6>
            * Recepit was created on a computer and is valid without the signature and seal.<br>
            * If you have any questions concerning this receipt, contact  [Name, Phone Number, Email].</h6>
         </div>
